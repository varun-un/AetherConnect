...
},{"./gsap-core.js":"../../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../../node_modules/gsap/CSSPlugin.js"}],"../simulations/planetaryOrbit/panels.js":[function(require,module,exports) {
"use strict";

var _gsap = require("gsap");

var controlsCard = document.getElementsByClassName('controlsCard')[0];
controlsCard.addEventListener('click', exitControls);

function exitControls() {
  document.getElementById('canvas').style.filter = 'blur(0px)';

  _gsap.TweenMax.to('.controlsCard', 2, {
    opacity: 0,
    y: '-110%',
    ease: _gsap.Power2.easeOut
  });

  controlsCard.removeEventListener('click', exitControls);
}
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../simulations/planetaryOrbit/panels.js"], null)
//# sourceMappingURL=/panels.f91f779e.js.map